...
#define INPUT_NUM_BUTTON	26 //Kitao更新。ハットスイッチ，16ボタン，Ｚ軸トリガにも対応。
...
enum KeyType
{
	...
	INPUT_JOYSTICK_L2ZTRIGGER = 0x01000000,//Kitao追加。Ｚ軸トリガにも対応。v2.81
	INPUT_JOYSTICK_R2ZTRIGGER = 0x02000000 //Kitao追加
};
